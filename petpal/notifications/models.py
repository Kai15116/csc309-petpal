...
class Notification(models.Model):
    ...
    notification_type = models.CharField(max_length=50, blank=True, help_text='The type of notification ("status_update", "application_creation", "new_message", "new_pet_listing")')
